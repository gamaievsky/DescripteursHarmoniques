...
def Parametres():
    ...
    accLab.grid(column = 0, row = 6)
    Lab_dim.grid(row = 7, column = 1)
    Lab_aug.grid(row = 8, column = 1)
    Lab_quarte.grid(row = 9, column = 1)
    But_dim.grid(row = 7, column = 2)
    But_aug.grid(row = 8, column = 2)
